import { shell, type ExecutionResult, type ExecuteOptions } from './shell';
...
export class Curl {
  ...
  static async post(url: string, data?: CurlOptions['data'], options: Omit<CurlOptions, 'method' | 'data'> = {}): Promise<CurlResponse> {
