	...
	<AlertDialog.Content>
		<AlertDialog.Header>
			...
			<AlertDialog.Description>
				...
				<br />
				<p>
					If you want to use the <strong>Window Movement</strong> feature, we suggest you go into <strong>System Settings → Privacy & Security → Accessibility</strong> and press the
